/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env=staging` (hash: d2268025a8c54813ca6d567ca7ab2d8b)
...
interface __BaseEnv_Env {
	...
	RelayChat: DurableObjectNamespace<import("./src/index").RelayChatAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "RelayChatAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MODEL_ID" | "RELAY_AGENT_HANDLE" | "RELAY_API_ORIGIN" | "RELAY_AGENT_TOKEN" | "RELAY_WEBHOOK_SECRET">> {}
}
