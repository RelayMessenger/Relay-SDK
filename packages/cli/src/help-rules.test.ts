...
// Proper names, capitalised as Relay Console shows them: the products, and
// the two lists an agent's access page names ("Always Allow", "Never Allow").
const products = /Always Allow|Never Allow|Relay Console|Claude Code|Gemini CLI|VS Code|OpenClaw|OpenCode|Relay|Codex|Hermes|Cursor|Cline|Pi/gu;
