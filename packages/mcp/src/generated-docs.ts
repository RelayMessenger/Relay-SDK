...
export const DOCS_SOURCE = {
  "contract": "3fb4873a3c09b7dade09012ecfc57acfef8cfb983b6b35fff9d320cf62bb3b00",
  "client": "07669fc04130796f3d5494917ea9f4899ec6a5ce95850d81f600c9911ff7450e",
  "types": "7dbf490b96c2f7a80f23b32e7dafb0085b3fc1c542bdd6f53f0726cfaa86e83e"
};
export const METHOD_DOCS: readonly MethodDoc[] = [
  ...
  },
  {
    ...
    "description": "Add or remove a reaction on one Message part. Targeting a `buttons`, `selection`, or `selection_response` part returns 422. Only a person can react to an `invoice` part; an agent gets 403 (error code `2003`).",
    "definitions": [
  ...
  {
    "method": "client.messages.invoice.update",
    "signature": "client.messages.invoice.update(messageID: string, body: MessageInvoiceUpdateParams, options?: RequestOptions): Promise<MessageInvoiceUpdateResponse>",
    "parameters": [
      "messageID: string",
    ...
    "description": "Move an `invoice` part's status. Only the agent that sent the Message may call this — the card turns itself into the new status in place. Any status to any status is allowed. Setting the current status is a no-op that still returns 200; a real change pushes `message.upserted` to every person in the chat and raises no webhook, since the agent authored the change itself.",
    "definitions": [
