...
export const DOCS_SOURCE = {
  "contract": "1d790da998a8dfc26cffc098def76d85b8275af7a343148df8e78c486cd02849",
  "client": "22d434138d13652b72de711d14c07203c3c4cbe14947a7aa8c1738f8d7d71570",
  "types": "dc555ea06ad68ff912788fc79a11e66bfa91ab633baf71fc03e1f66101ef623b"
};
export const METHOD_DOCS: readonly MethodDoc[] = [
  ...
  {
    "method": "client.calls.accept",
    "signature": "client.calls.accept(callID: string, options?: RequestOptions): Promise<CallResponse>",
    "parameters": [
      "callID: string",
      "options?: RequestOptions"
    ],
    ...
    "description": "The recipient accepts a ringing Call. The Call becomes connecting, not active.",
    "definitions": [
      "export interface RequestOptions {\n  signal?: AbortSignal;\n  timeout?: number;\n  maxRetries?: number;\n  headers?: HeadersInit;\n}",
  ...
  {
    "method": "client.calls.connected",
    "signature": "client.calls.connected(callID: string, options?: RequestOptions): Promise<CallResponse>",
    "parameters": [
      "callID: string",
      "options?: RequestOptions"
    ],
    ...
    "summary": "Report connected media",
    "description": "Report that this Contact has connected media. The Call becomes active only after both Contacts have reported media readiness.",
    "definitions": [
      "export interface RequestOptions {\n  signal?: AbortSignal;\n  timeout?: number;\n  maxRetries?: number;\n  headers?: HeadersInit;\n}",
      "export interface CallResponse {\n  call: Call;\n}",
      "export interface Call {\n  id: UUID;\n  chat_id: UUID;\n  from: CallContact;\n  to: [CallContact];\n  mode: \"audio\";\n  status: \"ringing\" | \"connecting\" | \"active\" | \"ended\";\n  revision: number;\n  created_at: string;\n  ringing_at: string;\n  answered_at: string | null;\n  connected_at: string | null;\n  ended_at: string | null;\n  end_reason: \"completed\" | \"declined\" | \"canceled\" | \"no_answer\" | \"disconnected\" | \"failed\" | null;\n}",
  ...
  {
    "method": "client.calls.connections.create",
    "signature": "client.calls.connections.create(callID: string, body: CallConnectionCreateParams, options?: RequestOptions): Promise<CallConnectionResponse>",
    "parameters": [
      "callID: string",
    ...
    "summary": "Connect call audio",
    "description": "Connect an accepted Call. Users connect with WebRTC; agent backends connect a live audio WebSocket. The returned media grant is scoped to the authenticated Contact and Call. Provider credentials remain on Relay servers.",
    "definitions": [
    ...
    "requestBody": {
      ...
      "content": {
        "application/json": {
          "schema": {
            "$ref": "#/components/schemas/CallConnectionRequest"
          }
        }
      }
    },
  ...
  {
    "method": "client.calls.connections.renegotiate",
    "signature": "client.calls.connections.renegotiate(callID: string, connectionID: string, body: { session_description: { type: \"answer\"; sdp: string } }, options?: RequestOptions): Promise<{ success: true }>",
    "parameters": [
      "callID: string",
      "connectionID: string",
    ...
    "summary": "Finish audio negotiation",
    "description": "Submit the WebRTC answer to an offer returned by subscribe.",
    "definitions": [
      "export interface RequestOptions {\n  signal?: AbortSignal;\n  timeout?: number;\n  maxRetries?: number;\n  headers?: HeadersInit;\n}"
    ],
    "requestBody": {
      ...
      "content": {
        "application/json": {
          "schema": {
            "$ref": "#/components/schemas/CallRenegotiateRequest"
          }
        }
      }
    },
  ...
  {
    "method": "client.calls.connections.subscribe",
    "signature": "client.calls.connections.subscribe(callID: string, connectionID: string, options?: RequestOptions): Promise<{ session_description: { type: \"offer\"; sdp: string } }>",
    "parameters": [
      "callID: string",
      "connectionID: string",
      "options?: RequestOptions"
    ...
    "summary": "Receive the other side’s audio",
    "description": "For a WebRTC connection, request the other side’s audio track. Apply the returned offer and submit your answer through renegotiate. A 409 means the other track is not ready; retry only during connection setup.",
    "definitions": [
      "export interface RequestOptions {\n  signal?: AbortSignal;\n  timeout?: number;\n  maxRetries?: number;\n  headers?: HeadersInit;\n}"
    ],
    "requestBody": {
  ...
  },
  {
    ...
    "description": "Start an audio Call in an existing individual Chat containing one user and one agent. The caller comes from authentication. The user must have added the agent; sending or replying to a Message establishes that relationship. A block in either direction prevents the call. A group Chat is rejected even when it has only two current members. Reuse the same Idempotency-Key and body after an uncertain response. Ringing has a 60-second setup lease; an accepted Call has 30 seconds to connect. Established calls have no duration limit imposed by these setup leases.",
    "definitions": [
  ...
  {
    "method": "client.calls.decline",
    "signature": "client.calls.decline(callID: string, options?: RequestOptions): Promise<CallResponse>",
    "parameters": [
      "callID: string",
      "options?: RequestOptions"
    ],
    ...
    "description": "The recipient declines a ringing Call. The Call ends with reason declined.",
    "definitions": [
      "export interface RequestOptions {\n  signal?: AbortSignal;\n  timeout?: number;\n  maxRetries?: number;\n  headers?: HeadersInit;\n}",
      "export interface CallResponse {\n  call: Call;\n}",
      "export interface Call {\n  id: UUID;\n  chat_id: UUID;\n  from: CallContact;\n  to: [CallContact];\n  mode: \"audio\";\n  status: \"ringing\" | \"connecting\" | \"active\" | \"ended\";\n  revision: number;\n  created_at: string;\n  ringing_at: string;\n  answered_at: string | null;\n  connected_at: string | null;\n  ended_at: string | null;\n  end_reason: \"completed\" | \"declined\" | \"canceled\" | \"no_answer\" | \"disconnected\" | \"failed\" | null;\n}",
  ...
  },
  {
    ...
    "operationId": "endCall",
    "summary": "End a call",
    "description": "Either Contact ends the Call. A ringing Call ends canceled; an answered Call ends completed. Cleanup remains available after a block or removal. Repeated terminal actions never restart the Call.",
    "definitions": [
      "export interface RequestOptions {\n  signal?: AbortSignal;\n  timeout?: number;\n  maxRetries?: number;\n  headers?: HeadersInit;\n}",
      "export interface CallResponse {\n  call: Call;\n}",
      "export interface Call {\n  id: UUID;\n  chat_id: UUID;\n  from: CallContact;\n  to: [CallContact];\n  mode: \"audio\";\n  status: \"ringing\" | \"connecting\" | \"active\" | \"ended\";\n  revision: number;\n  created_at: string;\n  ringing_at: string;\n  answered_at: string | null;\n  connected_at: string | null;\n  ended_at: string | null;\n  end_reason: \"completed\" | \"declined\" | \"canceled\" | \"no_answer\" | \"disconnected\" | \"failed\" | null;\n}",
  ...
  },
  {
    ...
    "description": "Add or remove a reaction on one Message part. Targeting a `buttons` part returns 422. Text and `button_reply` parts remain reactable.",
    "definitions": [
