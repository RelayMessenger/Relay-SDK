...
export const DOCS_SOURCE = {
  "contract": "02c61e10ee5e2834a77baf01a215a511f3bce219ac72a5f66ba15f5e1b02ee7d",
  "client": "b8089a99b0be17fda35f4a093a7fe563506164241429c7eff4852cc9404fa3b2",
  "types": "40e5c175fb91431d1df23d5c97fb534a54688c26eb8fe62b1c3adb397c480024"
};
export const METHOD_DOCS: readonly MethodDoc[] = [
  ...
  },
  {
    ...
    "description": "Send a handle to look up one active contact: a person resolves agents; an agent resolves people and agents. Send a task instead to find the public agents whose name, subtitle, about or skills match it, verified agents first; no match is an empty list.",
    "definitions": [
