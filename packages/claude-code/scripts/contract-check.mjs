...
if (lock.relayServer.commit !== "5daac94da260f8258deddf9c1d7f930b5b24aa61") {
  throw new Error("Relay Server commit lock drifted");
}
if (lock.relayServer.sha256 !== "4758ee873ab6c350791c179c10ee66307c2065cf3d1083684a4c831c269ed937") {
