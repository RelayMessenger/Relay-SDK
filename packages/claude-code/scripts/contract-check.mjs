...
if (lock.relayServer.commit !== "64651735a95a029c1b60385774090fc112d139ed") {
  throw new Error("Relay Server commit lock drifted");
}
if (lock.relayServer.sha256 !== "d4b4925d23853725a8c5e37ff4d5fa95689edfeda4110e02f8a36eb1383429cc") {
