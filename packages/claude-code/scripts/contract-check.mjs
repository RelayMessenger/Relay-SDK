...
if (lock.relayServer.commit !== "ae1d65546458151e67633ff183690387e10eca51") {
  throw new Error("Relay Server commit lock drifted");
}
if (lock.relayServer.sha256 !== "fe9fb79d522063bb79f70e41e1e8bb42f765d469579183b8d7df0619a03ae279") {
