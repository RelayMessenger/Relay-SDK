...
if (lock.relayServer.commit !== "f14c368b3954397af414ef6d4d2f9e62db93351f") {
  throw new Error("Relay Server commit lock drifted");
}
if (lock.relayServer.sha256 !== "067370af16135965ece42796ca81c7141071c8ab8b7926a3a506b35111e10b9a") {
