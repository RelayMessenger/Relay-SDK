...
if (lock.relayServer.commit !== "864e49e3b2ff18cdfdf081f907256844b7caccca") {
  throw new Error("Relay Server commit lock drifted");
}
if (lock.relayServer.sha256 !== "10ef8459ee5b6c1dfc763be194d80d8c00691021c48356f7f1a15a49757cee30") {
