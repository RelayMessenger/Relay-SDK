...
if (lock.relayServer.commit !== "c66e352b5e0915592980a68ac26c6b611d098d3c") {
  throw new Error("Relay Server commit lock drifted");
}
if (lock.relayServer.sha256 !== "23760079b90dd85624f18ab2351db3d13a7e7fcd683318eb7ffb540b3d9ea02f") {
