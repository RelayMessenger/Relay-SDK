...
if (lock.relayServer.commit !== "e72d4813a531539dae7ffdc8ddd19de3346ea1fe") {
  throw new Error("Relay Server commit lock drifted");
}
if (lock.relayServer.sha256 !== "f04d3359999ace37219eea0fd63c3ea4249d91ee91efe2ef86fdb63f2e236c69") {
