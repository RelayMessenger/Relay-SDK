import { BUTTONS_GUIDANCE, BUTTONS_BLOCK_INSTRUCTION, INVOICE_BLOCK_INSTRUCTION, INVOICE_GUIDANCE, LINK_LINE_INSTRUCTION, SELECTION_GUIDANCE, SELECTION_BLOCK_INSTRUCTION, selectionReplyContext } from "@relaymessenger/sdk";
import type {
  Message,
  Relay,
  RelayWebhookEvent,
