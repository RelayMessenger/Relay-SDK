...
export const SELECTION_GUIDANCE =
  ...
  + "Do not mix selection with buttons. Clear and toggles send nothing. "
  ...
  + "The reply contains text labels joined with ', ' and selection_response.selected_values in source-option order; "
